...
class ReordersDBTestIT {
    ...
    void testGetAllByBranch() {
        List<Reorder> reorders = reordersDB.getAllByBranch(1L, null);
        assertThat(reorders).hasSize(2);
    }

    @Test
    void testGetAllByBranchEmpty() {
        List<Reorder> reorders = reordersDB.getAllByBranch(2L, null);
    ...
    void testGetAllByBranchWithStatus() {
        ...
        List<Reorder> reorders = reordersDB.getAllByBranch(1L, ReorderStatus.DELIVERED);
    ...
    void testCreate() {
        ...
        assertThat(reordersDB.getAllByBranch(1L, null)).hasSize(3);
    ...
    void testCreateAutoIncrement() {
        ...
        assertThat(reordersDB.getAllByBranch(1L, null)).hasSize(1000);
    ...
    void testUpdateStatusExisting() {
        ...
        assertThat(reordersDB.getAllByBranch(1L, null)).hasSize(2);
    ...
    void testDeleteExisting() {
        ...
        assertThat(reordersDB.getAllByBranch(1L, null)).hasSize(1);
